...
function Universe() {
  ...
  const baseProjects = [
        ...
        },
        {
          id: 'owl',
          name: 'Owl',
          title: 'Save Polar Bear',
          description: 'Save Polar Bear is an interactive web-based game developed with p5.js that raises awareness about climate change and its impact on polar bear ecosystems. Players control a polar bear navigating a melting Arctic environment, collecting fish to survive while icebergs gradually disappear due to rising temperatures. The game features dynamic sprite animations, real-time environmental changes, power-up mechanics, and a comprehensive game state management system. Built with object-oriented programming principles, the project includes responsive design for both desktop and mobile devices, fullscreen mode support, and immersive audio integration. Through engaging gameplay mechanics — where players must balance survival with the accelerating effects of climate change — the game educates users about the urgent need to protect polar bear habitats and the broader Arctic ecosystem.',
          image: 'assets/constellation-owl.png',
          constellationImage: 'assets/constellation-owl.png',
          link: 'https://github.com/KimShota/Save-Polar-Bear',
          technologies: ['p5.js', 'JavaScript', 'HTML', 'CSS', 'Object-Oriented Programming', 'Game Development'],
